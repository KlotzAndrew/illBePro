        ...
        val_count += 1
          ...
          if name == x.validation_string
            ...
            if Score.find_by_summoner_id(x.summoner_id).nil?
              Score.create!(:summoner_id => x.summoner_id, :summoner_name => x.summoner_name, :week_2 => 0)
          ...
          if valid_games.nil?
            ...
            if x.kind == 1
              ...
              if valid_games.count == 0               
                ...
                Score.find_by_user_id(x.user_id).update(week_2: Score.find_by_user_id(x.user_id).week_2 + x.points)
                Score.find_by_summoner_id(x.summoner_id).update(week_2: Score.find_by_summoner_id(x.summoner_id).week_2 + x.points)
